                ...
                <Card.Body css={{ py: "$2" }}>
                    <div className="flex flex-row sm:flex-col sm:items-center gap-16">
                        <div className="flex-1 flex flex-col">
                            <h2 id="test" className={`${styles.headingRes} sm:leading-10 sm:text-[26px] sm:text-center text-[#3694ff]`}>Join the Discord server today!</h2>
                        ...
                        <div className="m-auto">
                            ...
                            >
                                <Button flat color="primary" size="xl" auto href="#" className="sm:h-12"
                                    ...
                                    css={{ color: '#ffffff' }}>
                                    <i className="bi bi-discord mr-4 text-[26px]"></i> Join Now!
                                </Button>
                            </motion.div>
                        </div>
                    </div>
